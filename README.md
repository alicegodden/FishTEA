...
Analysis of TE's in the genome to be able to plot a chromosomal plot. Can also take the chrom and pos columns of the retroseq vcf file input to this, and put this through Biomart online and use the co-ordinates tool, to generate a list of genes that overlap with the TE insertion sites. 
...
3. Chromosomal plotting of overlapping genes and TEs
